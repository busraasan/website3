# Generated by Django 2.0.1 on 2019-01-24 11:07

import ROVER2017.utils
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(upload_to=ROVER2017.utils.get_upload_path, verbose_name='photo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leader', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leader_of', to='ROVER2017.Member', verbose_name='subteam leader')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('member', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leader', to='ROVER2017.Member', verbose_name='team leader')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='member',
            name='subteam',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='members', to='ROVER2017.SubTeam', verbose_name='subteam of member'),
        ),
    ]
