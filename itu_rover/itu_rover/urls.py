...
from ROVER2017.views import onyediMembersPage
from ROVER2018.views import onsekizMembersPage
...
urlpatterns = [
    ...
    path('rover17/',onyediMembersPage.as_view(), name='rover17'),
    path('rover18/',onsekizMembersPage.as_view(), name='rover18'),
